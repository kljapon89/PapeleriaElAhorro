...
import { AwaitedReactNode, JSXElementConstructor, ReactElement, ReactNode, ReactPortal, useCallback } from "react";
...
const ManageProductsClient: React.FC<ManageProductsClientProps> = ({
  ...
  const columns: GridColDef[] = [
    ...
    { field: "name", headerName: "Name", width: 180 },
    {
      ...
      width: 100,
      renderCell: (params: { row: { price: string | number | bigint | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<AwaitedReactNode> | null | undefined; }; }) => {
        return (
    ...
    { field: "brand", headerName: "Marca", width: 150 },
    {
      ...
      headerName: "inStock",
      width: 100,
      renderCell: (params: { row: { inStock: boolean; }; }) => {
        return (
          <div>
    ...
    },
    {
      ...
      headerName: "Actions",
      width: 180,
      renderCell: (params: { row: { id: string; inStock: boolean; images: any[]; }; }) => {
        return (
          <div className="flex justify-between gap-3 w-full">
            ...
            <ActionBtn
              ...
              onClick={() => {
                ...
                const productPageRoute = newLocal
